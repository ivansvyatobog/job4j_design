...
class ArgsNameTest {
    ...
    @Test
    void whenArgumentsIsEmpty() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("Arguments not passed to program");
    }
    ...
    @Test
    void whenArgumentDoesNotMatchingFormat() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"encoding=UTF-8"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument 'encoding=UTF-8' does not start with a '-' character");
    }
}